                    ...
                    <div className="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
                        <div className="lg:flex lg:items-center">
                            <div className="flex justify-between">
                                <div>
                                    <a href="/"
                                       className="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300"><span
                                        className="text-blue-600">❯</span> ize:</a>
                                </div>
                            ...
                            <div
                                ...
                                <a href="/docs/index.html"
                                   className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200">docs</a>
                                <a href="#features"
                        ...
                        <div className="flex justify-center mt-6 lg:flex lg:mt-0 lg:-mx-2">
                            <a href="https://github.com/hazelops/ize" target="_blank"
