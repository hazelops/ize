...
func TestConsole(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:           []string{"-e=test", "-p=test", "console", "test"},
			withConfigFile: true,
			wantErr:        false,
			mockECSClient:  mockECS,
		},
		{
			...
			args:           []string{"-p=test", "console", "goblin"},
		...
		},
		{
			...
			args:          []string{"--aws-region", "us-east-1", "--namespace", "test-testnut", "console", "goblin"},
		...
		},
		{
			...
			args:          []string{"-e=test", "-r=us-east-1", "-p=test", "-n=test", "console", "squibby"},
			wantErr:       false,
			mockECSClient: mockECS,
		},
		{
