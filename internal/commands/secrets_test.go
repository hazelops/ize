...
//		{
//			name:           "success (only config file)",
//			args:           []string{"secrets", "edit", "squibby"},
//			env:            map[string]string{"ENV": "test", "AWS_PROFILE": "test"},
//			withConfigFile: true,
//			wantErr:        false,
//		},
...
//			cfg.Session = getSession(false)
//
//			c, err := expect.NewConsole(expect.WithStdout(os.Stdout), expect.WithStdin(os.Stdin), expect.WithDefaultTimeout(time.Second))
//			if err != nil {
//				t.Error(err)
//			}
//
...
//				errC <- err
//			}()
//			time.Sleep(time.Nanosecond * 1500)
//			c.Send("\n")
//			c.SendLine(":q!")
//
//			for {
