...
//}
//
//func NewDockerLocalstack(state string, command []string, env []string, out io.Writer, project *config.Project) *docker {
...
//
//	s.Done()
//	s = sg.Add("Cleaning up old containers...")
//
